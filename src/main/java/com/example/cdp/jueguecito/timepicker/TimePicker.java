...
public class TimePicker extends FrameLayout {
    ...
    public static final NumberPicker.Formatter NUMBER_FORMATTER =
            new Formatter() {
    ...
    public TimePicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        mMinutePicker.setFormatter(NUMBER_FORMATTER);
        ...
        // digits of seconds
//        String[] segundos = { "00", "15", "30", "45" };
        mSecondPicker = (NumberPicker) findViewById(R.id.seconds);
        mSecondPicker.setMinValue(0);
        //mSecondPicker.setMaxValue(segundos.length - 1);
        mSecondPicker.setMaxValue(59);
        //mSecondPicker.setDisplayedValues(segundos);
        mSecondPicker.setFormatter(NUMBER_FORMATTER);
        mSecondPicker.setOnValueChangedListener(new NumberPicker.OnValueChangeListener() {

            @Override
            public void onValueChange(NumberPicker picker, int oldVal, int newVal) {
          //      mCurrentSeconds = newVal * 15;
